...
DATA_DIR = '/projets/flowers2/tristan/data'

RAW_DATA_FILE = DATA_DIR + '/raw/rl_big/dataset_learning_conditions_all_feedback_big.pk'

folder_out = DATA_DIR + '/processed/rl_big_small'
...
obs = obs_raw[:2000]
descriptions_ids = descriptions_ids[:2000]
