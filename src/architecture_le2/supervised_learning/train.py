...
add('--architecture', type=str, help='Type of architecture to train', default='modular_attention')
add('--n_epochs', type=int, help='Number of training epochs', default=100)
    ...
    with tf.Session(config=session_conf) as sess:
        ...
        for i in range(n_epochs):
            ...
            for bb in range(n_batch):
                ...
                cost_val = sess.run(reward_func.get_cost(),
                                    feed_dict={reward_func.S: batch_s, reward_func.I: np.array(batch_i),
                ...
                costs_over_epoch.append(cost_val)

            mean_cost = np.mean(costs_over_epoch)
            cost_log.append(mean_cost)
            ...
            if i % 2 == 0:
                ...
                print("Epoch: " + str(i) + '/' + str(n_epochs) + " Cost: " +
                      str(cost_val) + " Accuracy: " + str(accuracy_val) + " Precision: " + str(precision_val))
        ...
        pickle_dump(cost_log, TRIAL_DIR + '/loss_log.pk')