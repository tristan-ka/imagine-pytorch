...
from src.architecture_le2.rl.ddpg import DDPG
...
from src.architecture_le2.rl.her import make_sample_her_transitions as make_sample_her_transitions_biased
from src.architecture_le2.reward_function.classifier_reward_function_lstm_pretrained import RewardFunctionLSTMPretrained
from src.architecture_le2.reward_function.classifier_reward_function_lstm_learned import RewardFunctionLSTM
from src.architecture_le2.reward_function.oracle_reward_function_playground import \
    OracleRewardFunction as OraclePlayground
...
from src.architecture_le2.language_model import LanguageModelLSTM

from src.architecture_le2.rl.ddpg_agent import DDPG as DDPGpytorch
from src.architecture_le2.rl.sac_agent2 import SACAgent
...
DEFAULT_CONFIG = dict(experiment_params=dict(trial_id=0,
                      ...
                      conditions=dict(env_name='PlaygroundNavigation-v1',
                                      ...
                                      bias_buffer=True,
                                      # whether the sampling of buffer fights unbalanced distributions of goals
                      ...
                      learning_params=dict(algo='sac',
                                           ...
                                           network_class='src.architecture_le2.rl.actor_critic:ActorCritic',
...
def configure_everything(rank, seed, num_cpu, env, trial_id, n_epochs, reward_function, policy_encoding,
                         bias_buffer, feedback_strategy, policy_architecture, goal_invention, reward_checkpoint,
                         rl_positive_ratio, p_partner_availability, git_commit=''):
    # Seed everything
    ...
    elif params['learning_params']['algo'] =='sac':
        params['learning_params']['network_class'] += 'SAC'
    else:
        raise NotImplementedError
    ...
    for n_obj in range(3, 4):
        params['or_params_path'][n_obj] = REPO_PATH + '/src/or_module/or_params_pytorch/or_params_{}objs.pk'.format(
            n_obj)
...
def configure_learning_algo(reward_function, goal_sampler, params, reuse=False, use_mpi=True):
    ...
    if params['learning_params']['algo'] == 'ddpg':
        ...
        policy = DDPGpytorch(params['learning_params'], sample_her_transitions)
    elif params['learning_params']['algo'] == 'sac':
        policy = SACAgent(params['learning_params'], sample_her_transitions)
    else:
        raise NotImplementedError
    return policy
