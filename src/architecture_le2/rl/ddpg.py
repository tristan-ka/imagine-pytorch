...
class DDPG(object):
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
                 ...
                 sample_transitions, gamma, bias_buffer=None, policy_architecture=None, reward_function=None, goal_sampler=None, reuse=False, **kwargs):
        ...
        Args:
            ...
            network_class (str): the network class that should be used (e.g. 'architecture_le2.her.ActorCritic')
