...
from src.architecture_le2.goal_generator.simple_sentence_generator import SentenceGeneratorHeuristic
...
class GoalSampler:
    def __init__(self,
        ...
        self.goal_generator = SentenceGeneratorHeuristic(sentences=None)
